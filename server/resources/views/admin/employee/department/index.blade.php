            ...
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                <a href="{{ route('department.create') }}"
                   class="btn btn-success pull-right m-l-20 hidden-xs hidden-sm waves-effect waves-light"> <i
                            class="fa fa-plus-circle" aria-hidden="true"></i> @lang('department.add_department')</a>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-12">
                                    ...
                                    @foreach($results AS $value)
                                        <tr class="{!! $value->department_id !!}">
                                            ...
                                            <td style="width: 100px;">
                                                <a href="{!! route('department.edit',$value->department_id) !!}"
                                                   class="btn btn-success btn-xs btnColor">
                                                    <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                                </a>
                                                <a href="{!!route('department.delete',$value->department_id )!!}"
