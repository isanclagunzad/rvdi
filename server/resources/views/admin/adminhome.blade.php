...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="row" id="react-hr-departments">
                                        ...
                                        <td>
                                            @if($dailyAttendance->photo != '')
                                                <img style=" width: 70px; "
                                                     src="{!! asset('uploads/employeePhoto/'.$dailyAttendance->photo) !!}"
        ...
        <div class="row">
            ...
            @if($ip_attendance_status == 1)
                ...
                <div class="col-md-6">
                    <div class="white-box">
                        <h3 class="box-title">Hey {!!   $logged_user[0]->user_name !!} please Check in/out your
                            attendance</h3>
                        <hr>
                                    ...
                                    <div class="comment-body">
                                        @if($leaveApplication->employee->photo !='')
                                            <div class="user-img"><img
                                                        src="{!! asset('uploads/employeePhoto/'.$leaveApplication->employee->photo) !!}"
                                                        alt="user" class="img-circle"></div>
                                        @else
                                            <div class="user-img"><img
                                                        src="{!! asset('admin_assets/img/default.png') !!}" alt="user"
                                        ...
                                        <div class="mail-contnet">
                                            ...
                                            @endphp
                                            <h5>{{$leaveApplication->employee->first_name}} {{$leaveApplication->employee->last_name}}</h5>
                                            <span class="time">{{date(" d M Y h:i: a", $d)}}</span> <span
                                    ...
                                    @lang('leave.purpose') : {{$leaveApplication->purpose}}
                                            ...
                                            <a href="javacript:void(0)" data-status=2
                                               ...
                                               class="btn remarksForLeave btn btn-rounded btn-success btn-outline m-r-5"><i
                                                        class="ti-check text-success m-r-5"></i>@lang('common.approve')
                                            </a>
                                            <a href="javacript:void(0)" data-status=3
                                               data-leave_application_id="{{$leaveApplication->leave_application_id}}"
                                               class="btn-rounded remarksForLeave btn btn-danger btn-outline"><i
                                                        class="ti-close text-danger m-r-5"></i>@lang('common.reject')
                                            </a></div>
                                    </div>
                                </div>
                            @endforeach
...
<script>
    var upcomingBirthdays = "{{ $upcoming_birthday }}";
    var employeeCategorisationCounter = "{{json_encode($employeeCategorisationCounter)}}";
    var totalAttendance = "{{json_encode([
