...
Route::group(['middleware' => ['preventbackbutton','auth']], function(){
    ...
    Route::delete('attendance/{attendance_id}/finger_print/{finger_print_id}/delete', ['as' => 'employee_attendance.delete', 'uses' => 'EmployeeAttendanceController@destroy']);
    ...
    Route::get('bulkAttendance', ['as' => 'attendance.bulk', 'uses' => 'Attendance\UploadAttendanceController@index']);
    Route::post('bulkAttendance', ['as' => 'attendance.store.bulk', 'uses' => 'Attendance\UploadAttendanceController@store']);
